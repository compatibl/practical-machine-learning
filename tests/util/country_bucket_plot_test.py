...
def country_bucket_plot_test(local_test_dir) -> None:
    """
    Approval test for CountryBucketPlot.

    The test is successful if output files match git state.
    """

    # Create plot
    plot = CountryBucketPlot()
    plot.input_file = "country_bucket"
    plot.x_feature = "short_rate(t)"
    plot.y_feature = "term_rate(t)"
